...
.nav-item{display:flex;align-items:center;gap:10px;padding:9px 18px;cursor:pointer;font-size:13px;color:var(--text2);text-decoration:none;transition:background var(--transition),color var(--transition);position:relative;user-select:none;margin:1px 8px;border-radius:8px}
...
.page-title{font-size:15px;font-weight:600;flex:1;color:var(--text)}
.topbar-actions{display:flex;align-items:center;gap:8px}
.btn{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;border-radius:var(--r);font-size:13px;font-weight:500;cursor:pointer;border:none;font-family:var(--font);text-decoration:none;transition:all var(--transition)}
...
.search-input{flex:1;background:var(--bg2);border:1px solid var(--border2);border-radius:var(--r);color:var(--text);font-size:14px;font-family:var(--font);padding:10px 14px;outline:none;transition:border-color var(--transition),box-shadow var(--transition)}
...
.modal{background:var(--bg2);border:1px solid var(--border);border-radius:var(--r2);width:560px;max-width:95vw;max-height:85vh;overflow-y:auto;transform:scale(.95) translateY(20px);transition:transform .2s;box-shadow:var(--shadow-lg)}
...
.modal-close{font-size:20px;cursor:pointer;color:var(--text3);transition:color var(--transition);padding:0;background:none;border:none}
.modal-close:hover{color:var(--text)}
.modal-body{padding:20px}
.modal-footer{padding:14px 20px;border-top:1px solid var(--border);display:flex;justify-content:flex-end;gap:8px}
.tabs{display:flex;gap:2px;border-bottom:2px solid var(--border);margin-bottom:20px}
.tab{padding:9px 16px;font-size:13px;font-weight:500;color:var(--text3);cursor:pointer;border-bottom:2px solid transparent;transition:all var(--transition);margin-bottom:-2px}
...
.page-link{padding:5px 10px;border-radius:var(--r);font-size:12px;background:var(--bg2);border:1px solid var(--border);color:var(--text2);cursor:pointer;transition:all var(--transition);text-decoration:none}
...
.font-mono{font-family:var(--mono)}.w-full{width:100%}
...
@media(max-width:900px){#sidebar{transform:translateX(-100%)}#main{margin-left:0}.grid-2,.grid-3,.grid-70-30,.grid-60-40{grid-template-columns:1fr}.pos-layout{grid-template-columns:1fr;height:auto}.payment-modes{grid-template-columns:repeat(4,1fr)}}
...
@media(max-width:900px){html[dir="rtl"] #sidebar{transform:translateX(100%)}html[dir="rtl"] #main{margin-right:0}}
<?php endif; ?>
</style>
</head>
<body>
...
<nav id="sidebar">
  <div class="sidebar-logo">
    ...
    <?php if ($company_logo): ?>
    <img src="<?= htmlspecialchars($company_logo) ?>" alt="Company Logo" style="max-height:36px;max-width:36px;border-radius:8px;object-fit:contain">
    <?php else: ?>
  ...
  <div class="sidebar-footer">
    ...
    <a href="<?= BASE ?>/logout.php" style="font-size:16px;cursor:pointer;color:var(--text3);text-decoration:none" title="<?= __('logout') ?>">🚪</a>
  </div>
</nav>
